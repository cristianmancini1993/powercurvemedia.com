...
GEOS = [
    {
        ...
        "lang": "ro",
        "offer": "151",
        "key": "bb683a4789afd9a940c447475cd5b75090d0b3ba",
        "price": 399,
        "currency": "RON",
        "was": "1.299 RON",
        "now": "399 RON",
    ...
    },
    {
        ...
        "lang": "cs",
        "offer": "152",
        "key": "05300963b61d1f87eadf5fc9c8b2ab1fdd42b927",
        "price": 1999,
        "currency": "CZK",
        "was": "6.599 Kč",
        "now": "1.999 Kč",
    ...
    },
    {
        ...
        "lang": "hu",
        "offer": "153",
        "key": "1e9397933fbbd0b8402458a8f24a03ce4df632d4",
        "price": 29999,
        "currency": "HUF",
        "was": "99.999 Ft",
        "now": "29.999 Ft",
    ...
    },
    {
        ...
        "lang": "sk",
        "offer": "154",
        "key": "b8c3be73cb8a2f06d218aa7de9de3295f9190283",
        "price": 79.99,
        "currency": "EUR",
        "was": "249,99 €",
        "now": "79,99 €",
    ...
    },
    {
        ...
        "lang": "pl",
        "offer": "155",
        "key": "f011af6defd2c2b02d279df0285fa2f3f250f845",
        "price": 349,
        "currency": "PLN",
        "was": "999 zł",
        "now": "349 zł",
...
T: dict[str, dict[str, str | list]] = {
    "ro": {
        "title": "TrimOne™ — Motocoasă Fără Fir 3000W | -50% Doar Azi",
        ...
        "og_title": "TrimOne™ — Motocoasă fără fir | -50% Doar Azi",
        ...
        "topbar": "DOAR AZI: -50% + LIVRARE GRATUITĂ ÎN 24H — PLATĂ LA LIVRARE",
        ...
        "countdown": "⏰ Reducerea -50% expiră în",
        ...
        "lbl_name": "Nume si Prenume*", "lbl_tel": "Telefon (de preferință mobil)*", "lbl_addr": "Adresa completă*",
        "ph_name": "Ion Popescu", "ph_tel": "+40 712 345 678", "ph_addr": "Str. Victoriei 10, 010001 București",
    ...
    "cz": {
        "title": "TrimOne™ — Akumulátorový Křovinořez 3000W | -50% Jen Dnes",
        ...
        "og_title": "TrimOne™ — Křovinořez bez kabelu | -50% Jen Dnes",
        ...
        "topbar": "JEN DNES: -50% + DOPRAVA ZDARMA DO 24H — PLATBA NA DOBÍRKU",
    ...
    "hu": {
        "title": "TrimOne™ — Vezeték Nélküli Fűkasza 3000W | -50% Csak Ma",
        ...
        "og_title": "TrimOne™ — Vezeték nélküli fűkasza | -50% Csak Ma",
        ...
        "topbar": "MA CSAK: -50% + INGYENES SZÁLLÍTÁS 24H — UTÁNVÉTES FIZETÉS",
        ...
        "countdown": "⏰ A -50% kedvezmény lejár",
        ...
        "lbl_name": "Név és vezetéknév*", "lbl_tel": "Telefon (lehetőleg mobil)*", "lbl_addr": "Teljes cím*",
        "ph_name": "Kovács István", "ph_tel": "+36 30 123 4567", "ph_addr": "Andrássy út 12, 1061 Budapest",
    ...
    "sk": {
        "title": "TrimOne™ — Akumulátorový Krovinorez 3000W | -50% Len Dnes",
        ...
        "og_title": "TrimOne™ — Krovinorez bez kábla | -50% Len Dnes",
        ...
        "topbar": "LEN DNES: -50% + DOPRAVA ZDARMA DO 24H — PLATBA NA DOBIERKU",
        ...
        "lbl_name": "Meno a priezvisko*", "lbl_tel": "Telefón (najlepšie mobilný)*", "lbl_addr": "Úplná adresa*",
    ...
    "pl": {
        "title": "TrimOne™ — Bezprzewodowa Podkaszarka 3000W | -50% Tylko Dziś",
        ...
        "og_title": "TrimOne™ — Podkaszarka bezprzewodowa | -50% Tylko Dziś",
        ...
        "topbar": "TYLKO DZIŚ: -50% + DARMOWA DOSTAWA W 24H — PŁATNOŚĆ PRZY ODBIORZE",
        ...
        "lbl_name": "Imię i nazwisko*", "lbl_tel": "Telefon (najlepiej komórkowy)*", "lbl_addr": "Pełny adres*",
...
def apply_index(html: str, g: dict, tr: dict) -> str:
    ...
    pairs: list[tuple[str, str]] = [
        ("TrimOne™ — Decespugliatore Senza Filo 3000W | -50% Solo Oggi", tr["title"]),
        (
        ...
        ("TrimOne™ — Decespugliatore senza filo | -50% Solo Oggi", tr["og_title"]),
        (
        ...
        (
            "SOLO OGGI: -50% + CONSEGNA GRATUITA IN 24H — PAGAMENTO ALLA CONSEGNA",
            tr["topbar"],
        ),
        (
        ...
        ("⏰ Lo sconto -50% scade tra", tr["countdown"]),
        ...
        ("SÌ, ORDINO TRIMONE™ A 79€", tr["cta_form"]),
