...
(function () {
  ...
  function getTrackingContext() {
    if (window.getpowercurvemediaTrackingContext) {
      return window.getpowercurvemediaTrackingContext();
    }
  ...
  function appendTrackingParams(url, context) {
    if (window.appendpowercurvemediaTrackingParams) {
      return window.appendpowercurvemediaTrackingParams(url, context);
    }
