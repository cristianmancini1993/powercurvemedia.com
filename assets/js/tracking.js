...
(function () {
  ...
  window.getpowercurvemediaTrackingContext = getTrackingContext;
  window.appendpowercurvemediaTrackingParams = appendTrackingParams;
  window.markpowercurvemediaCashboltSubmit = markCashboltFormSubmitted;

  window.firepowercurvemediaThankYouConversion = function (options) {
    options = options || {};
...
window.trackInitiateCheckout = function () {
  const C = window.SITE_CONFIG || {};
  const T = window.getpowercurvemediaTrackingContext ? window.getpowercurvemediaTrackingContext() : {};
...
window.trackPurchase = function (value, currency) {
  if (window.firepowercurvemediaThankYouConversion) {
    return window.firepowercurvemediaThankYouConversion({ value: value, currency: currency });
  }
